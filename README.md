...
5. **Chrome or Chromium** - The search agent opens the system browser visibly and reuses `~/.potlatch/search-chrome-profile` so cookies and consent state persist. Set `BREEZE_SEARCH_PROFILE` to use another non-default profile directory.
